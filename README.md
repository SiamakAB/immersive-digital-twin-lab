...
🌐 Exploring immersive, AI-augmented, and cloud-based digital twins for architecture, urban systems, and collaborative design.
...
| WebGIS Interop | Seamless integration with ArcGIS Pro, Enterprise, and Online; 2D dashboards ↔ 3D immersive exploration. |
...
- **Proposed XR roadmap and future planning**  
  ...
  👉 [`docs/xr-roadmap.md`](docs/xr-roadmap.md)
...
- **XR Activities and Implementation**  
  ...
  👉 [`docs/xr-activities.md`](docs/xr-activities.md)
...
- **Digital Waters GitHub organization**  
  ...
  👉 [DigitalWaters-fi on GitHub](https://github.com/DigitalWaters-fi)
